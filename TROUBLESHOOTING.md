...
**Can I have more than one Mail Window open at once, per tab?**
No — unlike the Text Editor, only one Mail Window is open per tab at a
time, matching Potato's own real behavior. Using Tools → Mail Window
